...
public class OpenCv implements VideoModule {
    ...
    public void configure(Window coreGUI, Settings settings, JTextArea... log) {
        ...
        logSystem.logON(log[0],"SecurLog.txt",5);
        logSystem.addLog("recLog", log[1]);
        logSystem.logON(log[1],"FacesLog.txt",1);
        ...
        cam = new VideoCapture(0);//"/home/diamind/NetBeansProjects/Simple-face-detector/src/main/resourсes/files/opencv/videos/video5");
    ...
    public void startVideo() {
        ...
        if (cam.isOpened()) {
            ...
            while (cumOn) {
                ...
                detector.findObject(frame, contours, bgStatus);
